                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right"
                                href="javascript:void(0)" id="new_invoice">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary edit_invoice" type="button"
                                            data-id="<?php echo $row['id'] ?>">Edit</button>
                                        <button class="btn btn-sm btn-danger delete_invoice" type="button"

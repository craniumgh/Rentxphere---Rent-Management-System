                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="title-single-box">
                            ...
                            <span class="color-text-a">We’re here to help! Whether you have questions, need support, or
                                just want to get in touch, you can reach out to us using the options below. Our team is
                                ready to assist you with any inquiries related to your renting experience.</span>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="contact-map box">
                            <div id="map" class="contact-map">
                                <iframe src="https://mapcarta.com/madina/Map" width="100%" height="450" frameborder="0"
                                ...
                                <div class="icon-box section-b2">
                                    ...
                                    <div class="icon-box-content table-cell">
                                        ...
                                        <div class="icon-box-content">
                                            <p class="mb-1">Email.
                                                <span class="color-a">RentXphere@ Ghc200</span>
                                            </p>
                                            <p class="mb-1">Phone.

...
<body>
    ...
    <center>
        <main id="main" class="row bg-white" style="width: 100%; display: flex; justify-content: center;">
            <!-- <div class="col-md-6 p-0">
            <div id="login-left" class="bg-white">
                <img src="./assetss/img/rentXphere.jpg" width="100%" class="vh-100">
            </div>
        </div> -->
            ...
            <div class="col-md-6">
                ...
                <div class="text-center mb-5 pt-5">
                    <a href="index1.php" class="logo logo-admin"><img src="./assetss/img/rentXphere.jpg" alt="logo"
                            width="250px" class="rounded-circle"></a>
                </div>
                        ...
                        <div class="card border-0 col-md-8 mx-auto">
                            <div class="card-body">
                                <form id="login-form">
                                    ...
                                    <center><button
                                            class="btn btn-primary btn-block waves-effect waves-light py-2 btn-1">Login</button>
                                    </center>
                                </form>
                            </div>
                        </div>

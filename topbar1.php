           ...
           <div class="col-md-2">
              <div class="float-right">
                 <div class=" dropdown mr-4">
                    <p></p>
                    <a href="#" class="text-dark" id="account_settings" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false"><img src="./assetss/img/rentXphere.jpg"
                    ...
                    <div class="dropdown-menu p-0" aria-labelledby="account_settings" style="left: -2.5em;">
                       ...
                       <a class="dropdown-item" href="javascript:void(0)" id="manage_my_account"><i
                             class="fa fa-cog text-muted"></i> Manage Account</a>
                       <a class="dropdown-item" href="ajax.php?action=logout"><i
                             class="fa fa-power-off text-muted"></i> Logout</a>
                    </div>
                 </div>
              </div>
           </div>

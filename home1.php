        ...
        <div class="col-lg-12">
            <div class="">
                <div class="">
                    ...
                    <hr>
                    <div
                        style="background: #121FCF; background: linear-gradient(to right, #121FCF 0%, #CF1512 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                           ...
                           <div class="row">
                               <div class="col-lg-12">
                                   <a href="index1.php?page=tenants" class="text-primary float-right">View List <span class="fa fa-angle-right"></span></a>
                               </div>
                           </div>
                           </div> -->
                            </div>
...
<footer
    ...
    <p class="text-muted mb-1 mb-md-0">Copyright © 2025 >RentXphere
        </a> </p>
